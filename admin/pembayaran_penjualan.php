        ...
        <div class="w-64 bg-gray-800 shadow-lg flex flex-col">
            <div class="flex-grow">
                ...
                <ul class="px-6 space-y-3">
                    ...
                    <li><a href="pembayaran_penjualan.php" class="flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200"><i class="bi bi-cash-coin"></i><span class="font-medium">Proses Service</span></a></li>
