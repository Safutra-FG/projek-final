            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-lg-4">
                        ...
                        <div class="col-md-6">
                            <div class="p-3 border rounded-3 h-100">
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li class="mb-2"><strong class="d-block">Jam Operasional:</strong>[Isi Jam Operasional, misal: 09:00 - 20:00]</li>
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><strong>Bank BCA</strong>
                                        <ul class="list-unstyled ps-3">
                                            <li>No. Rekening: <strong>[Isi Nomor Rekening BCA Anda]</strong></li>
                                            <li>Atas Nama: <strong>[Isi Nama Pemilik Rekening BCA]</strong></li>
                                        </ul>
                                    </li>
                                    <li class="mb-2"><strong>Dana (E-Wallet)</strong>
                                        <ul class="list-unstyled ps-3">
                                            <li>No. Dana: <strong>[Isi Nomor Dana Anda, biasanya No. HP]</strong></li>
                                            <li>Atas Nama: <strong>[Isi Nama Pemilik Akun Dana]</strong></li>
                                        </ul>
                                    </li>
                                    <li class="mb-2"><strong>Bank Mandiri</strong>
                                        <ul class="list-unstyled ps-3">
                                            <li>No. Rekening: <strong>[Isi Nomor Rekening Mandiri Anda]</strong></li>
                                            <li>Atas Nama: <strong>[Isi Nama Pemilik Rekening Mandiri]</strong></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="alert alert-warning mt-4" role="alert">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="bi bi-whatsapp text-success"></i> WhatsApp: <strong>[Isi Nomor WhatsApp Konfirmasi Anda]</strong></li>
                            <li><i class="bi bi-envelope-at-fill text-danger"></i> Email: <strong>[Isi Email Konfirmasi Anda]</strong></li>
                        </ul>
                    </div>
